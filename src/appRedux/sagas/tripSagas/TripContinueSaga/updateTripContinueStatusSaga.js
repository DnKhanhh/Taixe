...
import {updateTripContinueStatusApi} from 'appRedux/api/tripApi';
import Toast from 'react-native-toast-message';
import {HOT_KEY} from 'utils/AppConst';
import {t} from 'i18next';

export function* updateTripContinueStatusSaga({payload, type}) {
  ...
  yield invoke(
    function* execution() {
      console.log('id', id);
      const result = yield call(updateTripContinueStatusApi, {
        id,
        data,
      });
