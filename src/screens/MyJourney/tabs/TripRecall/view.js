...
const TripRecall = ({
  ...
  return (
    <AppView flex={1}>
      <AppView center paddingBottom={getSize.m(8)}>
        <TouchableOpacity
            ...
            <AppView marginHorizontal={getSize.m(12)} marginTop={getSize.m(16)}>
              <AppView rowAlignCenter space={'between'}>
                <AppText
                  ...
                  Kết quả tìm kiếm({listTripRecall.length})
                </AppText>
                <TouchableOpacity
      ...
      <FlatList
        ...
        contentContainerStyle={
          listTripRecall && listTripRecall.length > 0 ? {} : styles.emptyList
        }
