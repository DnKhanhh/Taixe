...
import { hidePhone, formatTimeRemain, hideEmail } from 'utils/appUtils';
          ...
          <AppView paddingHorizontal={8}>
            <AppText style={styles.subText}>
              {confirmOptions === otpOptions.phone
                ? t('common:titleOTPPhone', { phone: hidePhone(confirmOptions) })
                : t('common:titleOTPEmail', { email: hideEmail(confirmOptions) })}
            </AppText>
            <AppView height={48}>
            ...
            <AppView marginTop={24} style={STYLE_GLOBAL.containerCenter}>
              ...
              <TouchableOpacity
                onPress={() => {
                  onResendOtpButtonPress(confirmOptions);
